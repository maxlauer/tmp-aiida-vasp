...
cGuima gerado. O potencial a adicionar está no arquivo 'adiciona'.
cGuima A instruccao      inquire(file='adiciona',exist=lexist)
cGuima                   if(lexist)  open(unit=21,file='adiciona')
cGuima verifica se o arquivo existe. Se existir o arquivo é aberto e lido.
c
...
cGuima eletrostática para os orbitais de valencia.
      implicit none
c
      include 'radial.h'
      include 'orbital.h'
...
cGuima   Termina o cálculo das medias.
c
cag
      return
c
